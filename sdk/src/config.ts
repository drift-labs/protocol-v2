...
const configs: { [key in DriftEnv]: DriftConfig } = {
	local: {
		...
		CLEARING_HOUSE_PROGRAM_ID: 'GJWSKZQ6Zkda8UvE4gpvLNG97gcyukbpdSSxh7KFjj7b',
		USDC_MINT_ADDRESS: 'FQGtScLawtT8sE1bN56KwxwDDEDfhzcthim2PH2NkmHu',
		MOCK_USDC_FAUCET_ADDRESS: '2K5NQPjW1ZKECJMq3LQyWP8Mab4RCtknCHgxZKVZmJpE',
