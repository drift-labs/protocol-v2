...
export const configs: { [key in DriftEnv]: DriftConfig } = {
	devnet: {
		...
		MARKET_LOOK_UP_TABLE: 'FaMS3U4uBojvGn5FSDEPimddcXsCfwkKsFgMVVnDdxGb',
	},
	'mainnet-beta': {
		ENV: 'mainnet-beta',
		...
		MARKET_LOOK_UP_TABLE: 'D9cnvzswDikQDf53k4HpQ3KJ9y1Fv3HGGDFYMXnK5T6c',
	},
};
