...
export class TransactionConfirmationManager {
    ...
    private pendingConfirmations: Map<string, TransactionConfirmationRequest> = new Map();
    ...
    private async checkTransactionStatuses(requests: TransactionConfirmationRequest[]) {
