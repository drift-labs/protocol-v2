...
export async function getStateAccountPublicKeyAndNonce(
	programId: PublicKey
...
export async function getStateAccountPublicKey(
	programId: PublicKey
): Promise<PublicKey> {
	return (await getStateAccountPublicKeyAndNonce(programId))[0];
}
