...
describe("openbook v2 subscriber", function () {
    ...
    it ("works", async function () {
        ...
        const solUsdc = new PublicKey("AFgkED1FUVfBe2trPUDqSqK9QKd4stJrfzq5q1RwAFTa");
        ...
        const basePrecision = Math.ceil(1 / openbookV2Subscriber.market.baseNativeFactor.toNumber());
