...
/// Per-isolated-market margin result, sized to velocity's isolated position limit.
#[repr(C, align(16))]
...
fn anchor_err(e: program::error::ErrorCode) -> SdkError {
...
pub fn calculate_simplified_margin_requirement(
    ...
    for spot_position in &user.spot_positions {
        ...
        let oracle = market_state
            ...
            .ok_or_else(|| anchor_err(program::error::ErrorCode::OracleNotFound))?;
...
mod tests {
    ...
    use program::state::oracle::HistoricalOracleData;
