...
impl ProtocolIfSharesTransferConfig {
    pub fn validate_signer(&self, signer: &Pubkey) -> VelocityResult {
        validate!(
    ...
    pub fn update_epoch(&mut self, now: i64) -> VelocityResult {
    ...
    pub fn validate_transfer(&self, requested_transfer: u128) -> VelocityResult {
