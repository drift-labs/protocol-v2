...
use crate::controller::orders::{cancel_orders, validate_perp_market_within_price_band};
...
pub fn settle_pnl(
    ...
    validate_perp_market_within_price_band(&market, state, true, None, Some(oracle_price.cast()?))?;
