...
fn formualic_k_tests() {
    ...
    assert_eq!(
        market.amm.total_fee_minus_distributions() - 1000000013,
        -486
    ); // ~$0.000486 spent from slippage decrease
}
...
fn update_pool_balances_test_high_util_borrow() {
    ...
    spot_market.set_borrow_balance(10_u128.pow(19_u32));
...
fn update_pool_balances_revenue_to_fee_test() {
    ...
    spot_market.revenue_pool.set_scaled_balance(0);
    let res =
    ...
    assert_eq!(spot_market.deposit_balance(), 200 * SPOT_BALANCE_PRECISION);
    spot_market.revenue_pool.set_scaled_balance(9900000001000);
...
mod revenue_pool_transfer_tests {
    ...
    fn test_calculate_revenue_pool_transfer() {
        ...
        market.amm.set_total_fee_withdrawn(500 * QUOTE_PRECISION);
        market.amm.set_total_liquidation_fee(300 * QUOTE_PRECISION);
        ...
        let terminal_state_surplus = 1000 * QUOTE_PRECISION_I128;
        market.insurance_claim.max_revenue_withdraw_per_period = 20 * QUOTE_PRECISION_U64;
        market.amm.set_total_social_loss(100 * QUOTE_PRECISION);
        market.amm.set_total_exchange_fee(3000 * QUOTE_PRECISION);
        let result = calculate_revenue_pool_transfer(
            &market,
            &spot_market,
            amm_fee_pool_token_amount_after,
        ...
        market.insurance_claim.max_revenue_withdraw_per_period = 1000 * QUOTE_PRECISION_U64;
        market.amm.set_total_social_loss(100 * QUOTE_PRECISION);
        market.amm.set_total_liquidation_fee(800 * QUOTE_PRECISION);
        let result = calculate_revenue_pool_transfer(
            &market,
            &spot_market,
            amm_fee_pool_token_amount_after,
        ...
        market.insurance_claim.max_revenue_withdraw_per_period = 1000 * QUOTE_PRECISION_U64;
        market.amm.set_total_social_loss(100 * QUOTE_PRECISION);
        market.amm.set_total_liquidation_fee(200 * QUOTE_PRECISION);
        let result = calculate_revenue_pool_transfer(
            &market,
            &spot_market,
            amm_fee_pool_token_amount_after,
        ...
        let terminal_state_surplus = 1000 * QUOTE_PRECISION_I128;
        market.insurance_claim.max_revenue_withdraw_per_period = 1000 * QUOTE_PRECISION_U64;
        market.amm.set_total_social_loss(600 * QUOTE_PRECISION);
        let result = calculate_revenue_pool_transfer(
            &market,
            &spot_market,
            amm_fee_pool_token_amount_after,
        ...
        spot_market
            .revenue_pool
            .set_scaled_balance(15000 * SPOT_BALANCE_PRECISION);
