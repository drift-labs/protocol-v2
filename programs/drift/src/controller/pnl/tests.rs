...
pub fn user_no_position() {
    ...
    let mut market = PerpMarket {
        amm: AMM {
            ...
            base_asset_amount_long: BASE_PRECISION_I128.into(),
...
pub fn user_unsettled_negative_pnl() {
    ...
    expected_market
        .pnl_pool
        .set_scaled_balance(100 * SPOT_BALANCE_PRECISION);
    expected_market
        .amm
...
pub fn user_unsettled_positive_pnl_more_than_pool() {
    ...
    expected_market
        .amm
        .set_quote_asset_amount(-200 * QUOTE_PRECISION_I128);
...
pub fn user_unsettled_positive_pnl_less_than_pool() {
    ...
    expected_market
        .pnl_pool
        .set_scaled_balance(25 * SPOT_BALANCE_PRECISION);
    expected_market
        .amm
        .set_quote_asset_amount(-175 * QUOTE_PRECISION_I128);
    expected_market.number_of_users = 0;
...
pub fn market_fee_pool_receives_portion() {
    ...
    let mut market = PerpMarket {
        amm: AMM {
            ...
            base_asset_amount_long: BASE_PRECISION_I128.into(),
            oracle: oracle_price_key,
            total_fee_minus_distributions: QUOTE_PRECISION_I128.into(),
            historical_oracle_data: HistoricalOracleData {
                last_oracle_price: oracle_price.agg.price,
                last_oracle_price_twap_5min: oracle_price.agg.price,
                last_oracle_price_twap: oracle_price.agg.price,
    ...
    expected_market
        .pnl_pool
        .set_scaled_balance(149 * SPOT_BALANCE_PRECISION);
    expected_market
        .amm
        .fee_pool
        .set_scaled_balance(SPOT_BALANCE_PRECISION);
    expected_market
        .amm
...
pub fn market_fee_pool_pays_back_to_pnl_pool() {
    ...
    let mut market = PerpMarket {
        amm: AMM {
            ...
            fee_pool: PoolBalance {
                scaled_balance: (2 * SPOT_BALANCE_PRECISION).into(),
                market_index: QUOTE_SPOT_MARKET_INDEX,
                ..PoolBalance::default()
            },
            historical_oracle_data: HistoricalOracleData {
    ...
    expected_market
        .pnl_pool
        .set_scaled_balance(151 * SPOT_BALANCE_PRECISION);
    expected_market
        .amm
        .fee_pool
        .set_scaled_balance(SPOT_BALANCE_PRECISION);
...
pub fn user_long_positive_unrealized_pnl_up_to_max_positive_pnl() {
    ...
    let mut market = PerpMarket {
        amm: AMM {
            ...
            ask_quote_asset_reserve: (101 * AMM_RESERVE_PRECISION).into(),
            sqrt_k: (100 * AMM_RESERVE_PRECISION).into(),
            peg_multiplier: (151 * PEG_PRECISION).into(),
            max_slippage_ratio: 50,
            max_fill_reserve_fraction: 100,
            order_step_size: 10000000,
            quote_asset_amount: (-150 * QUOTE_PRECISION_I128).into(),
...
pub fn user_long_positive_unrealized_pnl_up_to_max_positive_pnl_price_breached() {
    ...
    let mut market = PerpMarket {
        amm: AMM {
            ...
            ask_quote_asset_reserve: (101 * AMM_RESERVE_PRECISION).into(),
            sqrt_k: (100 * AMM_RESERVE_PRECISION).into(),
            peg_multiplier: (121 * PEG_PRECISION).into(),
            max_slippage_ratio: 50,
            max_fill_reserve_fraction: 100,
            order_step_size: 10000000,
            quote_asset_amount: (-150 * QUOTE_PRECISION_I128).into(),
...
pub fn user_long_negative_unrealized_pnl() {
    ...
    let mut market = PerpMarket {
        amm: AMM {
            ...
            ask_quote_asset_reserve: (101 * AMM_RESERVE_PRECISION).into(),
            sqrt_k: (100 * AMM_RESERVE_PRECISION).into(),
            peg_multiplier: (51 * PEG_PRECISION).into(),
            max_slippage_ratio: 50,
            max_fill_reserve_fraction: 100,
            order_step_size: 10000000,
            quote_asset_amount: (-150 * QUOTE_PRECISION_I128).into(),
...
pub fn isolated_perp_position_negative_pnl() {
    ...
    let mut expected_market = market;
    expected_market.pnl_pool.scaled_balance = (100 * SPOT_BALANCE_PRECISION).into();
    expected_market.amm.quote_asset_amount = (-100 * QUOTE_PRECISION_I128).into();
    expected_market.number_of_users = 0;
...
pub fn isolated_perp_position_user_unsettled_positive_pnl_less_than_pool() {
    ...
    let mut expected_market = market;
    expected_market.pnl_pool.scaled_balance = (25 * SPOT_BALANCE_PRECISION).into();
    expected_market.amm.quote_asset_amount = (-175 * QUOTE_PRECISION_I128).into();
    expected_market.number_of_users = 0;
