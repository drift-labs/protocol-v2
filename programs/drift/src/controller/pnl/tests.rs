...
#[test]
pub fn settle_pnl_clears_isolated_balance_when_no_unsettled_pnl() {
    let clock = Clock {
        slot: 0,
        epoch_start_timestamp: 0,
        epoch: 0,
    ...
    assert_eq!(
        ...
        150 * SPOT_BALANCE_PRECISION_U64
    );
}

#[test]
pub fn settle_pnl_no_unsettled_pnl_isolated_open_position_returns_no_unsettled_pnl() {
    let clock = Clock {
        slot: 0,
        epoch_start_timestamp: 0,
        epoch: 0,
    ...
    let initial_isolated = user.perp_positions[0].isolated_position_scaled_balance;
    let initial_spot = user.spot_positions[0].scaled_balance;
    ...
    assert_eq!(result, Err(ErrorCode::NoUnsettledPnl));
    assert_eq!(
        user.perp_positions[0].isolated_position_scaled_balance,
        initial_isolated
    );
    assert_eq!(user.spot_positions[0].scaled_balance, initial_spot);
}

#[test]
pub fn settle_pnl_no_unsettled_pnl_isolated_zero_balance_returns_no_unsettled_pnl() {
    let clock = Clock {
        slot: 0,
        epoch_start_timestamp: 0,
        epoch: 0,
