pub mod liquidate_perp {
    ...
    #[test]
    pub fn successful_liquidation_long_perp_with_negative_basis_5min() {
        let now = 0_i64;
        let slot = 0_u64;
        ...
        let mut market = PerpMarket {
            amm: AMM {
                ...
                base_asset_amount_with_amm: BASE_PRECISION_I128,
                oracle: oracle_price_key,
                last_mark_price_twap_5min: 100 * PRICE_PRECISION_U64 * 999 / 1000,
                historical_oracle_data: HistoricalOracleData {
        ...
        assert_eq!(user.perp_positions[0].base_asset_amount, 0);
        assert_eq!(user.perp_positions[0].quote_asset_amount, -51099000);
        assert_eq!(user.perp_positions[0].open_orders, 0);
        assert_eq!(user.perp_positions[0].open_bids, 0);
        ...
        assert_eq!(liquidator.perp_positions[0].quote_asset_amount, -98901000);
    ...
    #[test]
    pub fn successful_liquidation_short_perp_with_positive_basis_5min() {
        let now = 0_i64;
        let slot = 0_u64;
        ...
        let mut market = PerpMarket {
            amm: AMM {
                ...
                base_asset_amount_with_amm: BASE_PRECISION_I128,
                oracle: oracle_price_key,
                last_mark_price_twap_5min: 100 * PRICE_PRECISION_U64 * 1001 / 1000,
                historical_oracle_data: HistoricalOracleData {
                    last_oracle_price_twap: 100 * PRICE_PRECISION_I64,
                    last_oracle_price_twap_5min: 100 * PRICE_PRECISION_I64,
                    ..HistoricalOracleData::default()
        ...
        assert_eq!(user.perp_positions[0].base_asset_amount, 0);
        assert_eq!(user.perp_positions[0].quote_asset_amount, -51101000);
        assert_eq!(user.perp_positions[0].open_orders, 0);
        assert_eq!(user.perp_positions[0].open_bids, 0);
        ...
        assert_eq!(liquidator.perp_positions[0].quote_asset_amount, 101101000);
