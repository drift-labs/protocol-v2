...
fn amm_ref_price_offset_decay_logic() {
    ...
    assert_eq!(
        offsets,
        [
            6432, 5628, 4925, 4310, 3772, 3301, 3301, 3301, 3301, 3301, 2889, 2528, 2212, 1936,
            1694, 1483, 1298, 1136, 994, 870, 762, 667, 584, 511, 448, 392, 343, 301, 264, 231,
            203, 178, 156, 137, 120, 105, 92, 81, 71, 61, 51, 41, 31, 21, 11, 1, 0, 0, 0, 0
        ]
    );
    assert_eq!(
        lspreads,
        [
            928, 814, 713, 625, 548, 481, 10, 10, 10, 10, 422, 371, 326, 286, 252, 221, 195, 172,
            152, 134, 118, 105, 93, 83, 73, 66, 59, 52, 47, 43, 38, 35, 32, 29, 27, 25, 23, 21, 20,
