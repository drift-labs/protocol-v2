...
use crate::math::orders::calculate_quote_entry_amount_for_fill;
...
pub fn handle_transfer_perp_position<'c: 'info, 'info>(
    ...
    let (from_quote_entry_amount, to_quote_entry_amount) = {
        ...
        (from_quote_entry_amount, to_quote_entry_amount)
    };
    ...
    let fill_record = OrderActionRecord {
        ...
        oracle_price,
        bit_flags: 0,
        taker_quote_entry_amount: to_quote_entry_amount,
        maker_quote_entry_amount: from_quote_entry_amount,
    };
