...
use crate::state::swift_user::{SwiftOrderId, SwiftUser, SWIFT_PDA_SEED};
...
pub fn handle_place_swift_taker_order<'c: 'info, 'info>(
    ...
    let mut swift_taker = load_mut!(ctx.accounts.swift_user)?;
...
pub fn place_swift_taker_order<'c: 'info, 'info>(
    ...
    swift_account: &mut RefMut<SwiftUser>,
