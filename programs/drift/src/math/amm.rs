...
pub fn calculate_terminal_price(amm: &mut AMM) -> DriftResult<u128> {
...
pub fn sanitize_new_price(new_price: i128, last_price_twap: i128) -> DriftResult<i128> {
...
pub fn update_amm_mark_std(amm: &mut AMM, now: i64, price: u128, ewma: u128) -> DriftResult<bool> {
    let since_last = cast_to_i128(max(
        1,
...
pub fn calculate_terminal_price_and_reserves(amm: &AMM) -> DriftResult<(u128, u128, u128)> {
...
pub fn calculate_mark_twap_spread_pct(amm: &AMM, reserve_price: u128) -> DriftResult<i128> {
...
pub fn calculate_net_user_pnl(amm: &AMM, oracle_price: i128) -> DriftResult<i128> {
    validate!(
        oracle_price > 0,
        ErrorCode::DefaultError,
        "oracle_price <= 0",
