...
pub fn update_k(market: &mut PerpMarket, update_k_result: &UpdateKResult) -> DriftResult {
    market
        .amm
        .set_base_asset_reserve(update_k_result.base_asset_reserve);
    market
        .amm
        .set_quote_asset_reserve(update_k_result.quote_asset_reserve);
    market.amm.set_sqrt_k(update_k_result.sqrt_k);
    ...
    crate::controller::amm::update_spreads(market, reserve_price_after, None)?;
