...
mod calculate_max_spot_order_size {
    ...
    #[test]
    pub fn usdc_deposit_with_smaller_asset_weight_and_5x_sol_bid() {
        let slot = 0_u64;
        ...
        assert_eq!(max_order_size, 431817727272);
    ...
    #[test]
    pub fn usdc_deposit_with_smaller_asset_weight_and_5x_sol_sell() {
        let slot = 0_u64;
        ...
        assert_eq!(max_order_size, 345454181818);
        ...
        assert_eq!(total_collateral.unsigned_abs() - 1, margin_requirement);
    }
