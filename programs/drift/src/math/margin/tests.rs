...
#[cfg(test)]
mod margin_calculation_track_margin_ratio {
    use std::str::FromStr;
    ...
    use crate::test_utils::*;
    use crate::test_utils::{get_positions, get_pyth_price};
    use crate::{create_account_info, PERCENTAGE_PRECISION, PRICE_PRECISION};
    ...
    pub fn sol_perp_10x() {
        ...
        let calculation = calculate_margin_requirement_and_total_collateral_and_liability_info(
            ...
            &spot_market_map,
            &mut oracle_map,
            MarginContext::liquidation(0).track_margin_ratio().unwrap(),
        )
        .unwrap();

        let margin_ratio = calculation.get_margin_ratio().unwrap();

        assert_eq!(margin_ratio, PRICE_PRECISION / 10); // .00
        ...
        let user = User {
            ...
            perp_positions: get_positions(PerpPosition {
                market_index: 0,
                base_asset_amount: 10 * BASE_PRECISION_I64,
                quote_asset_amount: -1100 * QUOTE_PRECISION_I64,
                ..PerpPosition::default()
            }),
            spot_positions,
            ..User::default()
        ...
        let user = User {
            ...
            perp_positions: get_positions(PerpPosition {
                market_index: 0,
                base_asset_amount: 10 * BASE_PRECISION_I64,
                quote_asset_amount: -900 * QUOTE_PRECISION_I64,
                ..PerpPosition::default()
            }),
            spot_positions,
            ..User::default()
        ...
        assert_eq!(margin_ratio, PRICE_PRECISION / 5); //.20
    }

    #[test]
    pub fn sol_deposit_usdc_borrow() {
        let slot = 0_u64;
        ...
        assert_eq!(margin_ratio, 111111); // $10/$90 = .111111
        ...
        assert_eq!(margin_ratio, PERCENTAGE_PRECISION / 10); // $10/$100 = .1
    }
}
