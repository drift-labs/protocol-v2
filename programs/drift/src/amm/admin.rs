...
pub fn handle_repeg_amm_curve(ctx: Context<RepegCurve>, new_peg_candidate: u128) -> Result<()> {
    ...
    let adjustment_cost = crate::amm::refresh::repeg(
        perp_market,
        price_oracle,
        new_peg_candidate,
        clock_slot,
...
pub fn handle_update_k(ctx: Context<AdminUpdateK>, sqrt_k: u128) -> Result<()> {
    ...
    let adjustment_cost: i128 =
        crate::amm::math::cp_curve::adjust_k_cost(&perp_market.amm, &update_k_result)?;
    ...
    let price_after = crate::amm::math::amm::calculate_price(
...
pub fn handle_update_perp_market_reference_price_offset_deadband_pct(
    ...
    let liquidity_ratio =
        crate::amm::math::spread::calculate_inventory_liquidity_ratio_for_reference_price_offset(
