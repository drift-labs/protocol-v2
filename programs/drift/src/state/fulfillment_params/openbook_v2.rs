...
use anchor_lang::{account, AccountDeserialize, InstructionData, Key};
...
use openbook_v2::{Market, PlaceOrderType, Side, BookSide};
...
impl<'a, 'b> SpotFulfillmentParams for OpenbookV2FulfillmentParams<'a, 'b> {
    ...
    fn fulfill_order(&mut self,
        ...
        let max_quote_lots_including_fees = taker_max_quote_asset_amount as i64/market.quote_lot_size;
