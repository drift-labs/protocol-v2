...
impl PerpMarket {
    ...
    pub fn get_liquidation_fee_multiplier(&self, base_asset_amount: i128) -> DriftResult<u128> {
...
impl AMM {
    ...
    pub fn reserve_price(&self) -> DriftResult<u128> {
        amm::calculate_price(
    ...
    pub fn bid_price(&self, reserve_price: u128) -> DriftResult<u128> {
    ...
    pub fn ask_price(&self, reserve_price: u128) -> DriftResult<u128> {
    ...
    pub fn bid_ask_price(&self, reserve_price: u128) -> DriftResult<(u128, u128)> {
    ...
    pub fn get_oracle_twap(&self, price_oracle: &AccountInfo) -> DriftResult<Option<i128>> {
    ...
    pub fn get_pyth_twap(&self, price_oracle: &AccountInfo) -> DriftResult<i128> {
