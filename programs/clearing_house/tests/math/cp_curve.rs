...
use crate::math::amm::calculate_terminal_price_and_reserves;
use crate::math::constants::{
    AMM_RESERVE_PRECISION, BASE_PRECISION_U64, K_BPS_UPDATE_SCALE, MAX_CONCENTRATION_COEFFICIENT,
    MAX_K_BPS_DECREASE, MAX_K_BPS_INCREASE, QUOTE_PRECISION, QUOTE_PRECISION_I64,
};
...
fn calculate_k_tests() {
    ...
    let (t_price2, t_qar2, t_bar2) = calculate_terminal_price_and_reserves(&market.amm).unwrap();
