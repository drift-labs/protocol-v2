...
use crate::math::amm::{
    calculate_expiry_price, calculate_net_user_pnl, calculate_terminal_price_and_reserves,
    update_amm_mark_std, update_mark_twap, update_oracle_price_twap,
};
...
fn calculate_net_user_pnl_test() {
    ...
    let net_user_pnl = calculate_net_user_pnl(&market.amm, 17501 * PRICE_PRECISION_I128).unwrap();
