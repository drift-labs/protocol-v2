...
mod auto_deleveraging {
    ...
    fn imbalance_base_pnl_adl() {
        let market = PerpMarket {
            amm: AMM {
                ...
                quote_asset_amount: QUOTE_PRECISION_I128 * 5,
        ...
        .unwrap();
        assert_eq!(delev_payment, 950000);
        ...
        .unwrap();
        assert_eq!(delev_payment, 9950000);
        ...
        .unwrap();
        assert_eq!(delev_payment, 10767790);
    ...
    fn multiple_users_first_to_adl_test() {
        ...
        let market = PerpMarket {
            amm: AMM {
                ...
                quote_asset_amount: quote_asset_amount_long + quote_asset_amount_short,
                quote_break_even_amount_long: -QUOTE_PRECISION_I128 * 30 * 100 * 8 / 10,
                quote_break_even_amount_short: QUOTE_PRECISION_I128 * 30 * 54 * 12 / 10,
                quote_entry_amount_long: -QUOTE_PRECISION_I128 * 30 * 100 * 8 / 10,
                quote_entry_amount_short: QUOTE_PRECISION_I128 * 30 * 54 * 12 / 10,
                ..AMM::default()
            },
            number_of_users_with_base: 5,
            number_of_users: 5, // todo, at least 6 with base or quote including the loss
            ..PerpMarket::default()
        };
        ...
        assert_eq!(
            ...
            quote_asset_amount_long as i64
        );
        assert_eq!(
            dus1.quote_break_even_amount
                + dus2.quote_break_even_amount
                + dus3.quote_break_even_amount
                + dus7.quote_break_even_amount,
        ...
        assert_eq!(
            ...
            quote_asset_amount_short as i64
        );
        assert_eq!(
            dus4.quote_break_even_amount
                + dus5.quote_break_even_amount
                + dus6.quote_break_even_amount,
    ...
    fn multiple_users_adl_sequence_test() {
        ...
        assert_eq!(delev_payment, 23_999_977);
        assert_eq!(
            dus1.quote_break_even_amount * PRICE_TIMES_AMM_TO_QUOTE_PRECISION_RATIO_I128 as i64
                / dus1.base_asset_amount,
            -22745098
        );

        dus1.quote_asset_amount -= delev_payment as i64;
        dus1.quote_break_even_amount -= delev_payment as i64;
        ...
        assert_eq!(dus1.quote_break_even_amount, -719999977);
        ...
        assert_eq!(dus1.quote_break_even_amount, -727199973);
        assert_eq!(dus1.base_asset_amount, 30600000000);
        ...
        assert_eq!(
            dus2.quote_break_even_amount * PRICE_TIMES_AMM_TO_QUOTE_PRECISION_RATIO_I128 as i64
                / dus2.base_asset_amount,
            -23529411
        );
        let delev_payment = calculate_perp_market_deleverage_payment(
        ...
        dus2.quote_break_even_amount -= delev_payment as i64;
        market.amm.quote_break_even_amount_long -= delev_payment;
        market.amm.quote_entry_amount_long -= delev_payment;
        remaining_levered_loss += delev_payment;

        assert_eq!(dus2.quote_asset_amount, -25801999);
        assert_eq!(dus2.quote_break_even_amount, -24311999);
        assert_eq!(dus2.base_asset_amount, 1020000000);
        assert_eq!(remaining_levered_loss, -168_488_028);

        // lets switch over again now
        assert_eq!(
            dus3.quote_break_even_amount * PRICE_TIMES_AMM_TO_QUOTE_PRECISION_RATIO_I128 as i64
                / dus3.base_asset_amount,
            -23870417
        );
        let delev_payment = calculate_perp_market_deleverage_payment(
        ...
        dus3.quote_break_even_amount -= delev_payment as i64;
        market.amm.quote_break_even_amount_long -= delev_payment;
        market.amm.quote_entry_amount_long -= delev_payment;
        remaining_levered_loss += delev_payment;
    ...
    fn multiple_users_adl_automated_sequence_test() {
        ...
        while remaining_levered_loss < 0 && count < 1000 {
            for (idx, mut dus) in dus_list.iter_mut().enumerate() {
                let delev_payment = calculate_perp_market_deleverage_payment(
                    remaining_levered_loss,
                    **dus,
                    &market,
                ...
                if delev_payment > 0 {
                    ...
                    dus.quote_break_even_amount -= delev_payment as i64;
                    market.amm.quote_break_even_amount_long -= delev_payment;
                    market.amm.quote_entry_amount_long -= delev_payment;
                    remaining_levered_loss += delev_payment;
                    zaps += 1;
