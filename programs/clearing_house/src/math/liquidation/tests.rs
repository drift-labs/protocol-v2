...
mod calculate_liability_transfer_to_cover_margin_shortage {
    ...
    //         let liq_fee = LIQUIDATION_FEE_PRECISION / 10;
    ...
    //             asset_liquidation_multiplier,
    //             liability_weight,
    //             liability_liquidation_multiplier - pct_d_mult,
    //             liability_decimals,
    //             liability_price,
    //         )
    //         .unwrap();

    //         // assert_eq!(liability_transfer, 452202224); // .25 base
    //         let additional = liability_transfer - 449984250;
    ...
    //         );
    //         assert_eq!(
    //             (additional * LIQUIDATION_FEE_PRECISION) / liability_transfer,
    //             4904
    //         ); // .25 base
    //         assert_eq!(
    ...
    //         assert_eq!(liability_transfer, 447807979); // .25 base
    //         let missing = 449984250 - liability_transfer;
    //         assert_eq!(missing, 2176271); // .25 base
    //     }
}
