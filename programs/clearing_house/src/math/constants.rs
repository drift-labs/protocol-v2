...
pub const MARK_PRICE_PRECISION: u128 = 1_000_000_0000; //expo = -6;
...
pub const PEG_PRECISION: u128 = 1_000_000_0000; //expo = -6
...
pub const QUOTE_TO_BASE_AMT_FUNDING_PRECISION: i128 =
    (AMM_RESERVE_PRECISION * MARK_PRICE_PRECISION * FUNDING_RATE_BUFFER / QUOTE_PRECISION) as i128; // expo: 21
...
pub const FUNDING_RATE_TO_QUOTE_PRECISION_PRECISION_RATIO: u128 =
    MARK_PRICE_PRECISION * FUNDING_RATE_BUFFER / QUOTE_PRECISION;
pub const FUNDING_RATE_PRECISION_I128: i128 = MARK_PRICE_PRECISION_I128 * FUNDING_RATE_BUFFER_I128; // expo: 14
