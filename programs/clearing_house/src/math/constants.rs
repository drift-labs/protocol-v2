...
pub const COLLATERAL_PRECISION: u128 = 1_000_000; // expo = 6
...
pub const AMM_TO_COLLATERAL_PRECISION_RATIO: u128 = AMM_ASSET_AMOUNT_PRECISION / COLLATERAL_PRECISION; // expo: 7
pub const AMM_TO_COLLATERAL_PRECISION_RATIO_I128: i128 =
    (AMM_ASSET_AMOUNT_PRECISION / COLLATERAL_PRECISION) as i128; // expo: 7
pub const COLLATERAL_TO_BASE_AMT_FUNDING_PRECISION: i128 =
    (AMM_ASSET_AMOUNT_PRECISION * MARK_PRICE_MANTISSA * FUNDING_PAYMENT_MANTISSA / COLLATERAL_PRECISION)
        as i128; // expo: 21
