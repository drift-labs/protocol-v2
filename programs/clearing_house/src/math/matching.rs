...
mod test {
    ...
    fn filler_multiplier_maker_long() {
        ...
        let oracle_price = 34 * MARK_PRICE_PRECISION_I128;
        ...
        let maker_price_bad = 30 * MARK_PRICE_PRECISION;
        let maker_price_good = 40 * MARK_PRICE_PRECISION;
    ...
    fn filler_multiplier_maker_short() {
        ...
        let maker_price_good = 30 * MARK_PRICE_PRECISION;
        let maker_price_bad = 40 * MARK_PRICE_PRECISION;
