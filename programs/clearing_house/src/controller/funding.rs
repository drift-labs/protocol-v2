...
use crate::controller::position::{
    get_position_index, update_quote_asset_and_entry_amount, PositionDirection,
};
...
pub fn settle_funding_payment(
    ...
    if amm_cumulative_funding_rate != market_position.last_cumulative_funding_rate.cast()? {
        ...
        update_quote_asset_and_entry_amount(market_position, market, market_funding_payment)?;
    }
