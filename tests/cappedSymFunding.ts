...
async function cappedSymFundingScenario(
	...
	console.log(
		...
		convertToNumber(
			fundingRateLong,
			MARK_PRICE_PRECISION.mul(FUNDING_MANTISSA)
		),
		'fundingRateShort',
		convertToNumber(
			fundingRateShort,
	...
	console.log(
		'baseAssetAmountLong',
		convertToNumber(marketNew.baseAssetAmountLong, BASE_ASSET_PRECISION),
	...
	console.log(
		'fundingPnLForLongs',
		convertToNumber(
			fundingPnLForLongs.div(MARK_PRICE_PRECISION.mul(FUNDING_MANTISSA)),
			precisionFundingPay
		),
		'fundingPnLForShorts',
		convertToNumber(
			fundingPnLForShorts.div(MARK_PRICE_PRECISION.mul(FUNDING_MANTISSA)),
			precisionFundingPay
		)
	);
