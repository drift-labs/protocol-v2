...
const insuranceFundStakeRoutes: FastifyPluginAsync = async (fastify): Promise<void> => {
	...
	fastify.get<{
		...
		'/:year/:month/:day',
		{
			...
			schema: {
				description:
					'<p>Retrieve insurance fund stake records for a market for a given year and month.</p>',
				tags: ['Market'],
				params: {
					type: 'object',
					properties: {
...
export default insuranceFundStakeRoutes;
